...
var adminSystem = (function () {
  ...
  var POST_REGISTRY = [
    ...
    { id:'post-calculate-expression',    path:'how-to-calculate-expression-number',                 title:'How to Calculate Your Expression Number',                  category:'practice'    },
    { id:'post-calculate-soul-urge',     path:'how-to-calculate-soul-urge-number',                  title:'How to Calculate Your Soul Urge Number',                   category:'practice'    },
    { id:'post-calculate-personality',   path:'how-to-calculate-personality-number',                title:'How to Calculate Your Personality Number',                 category:'practice'    },
    { id:'post-hearts-desire',           path:'hearts-desire-vs-soul-urge-numerology',              title:"Heart's Desire vs Soul Urge",                              category:'practice'    },
    { id:'post-numerology-chart',        path:'numerology-chart-explained',                         title:'What Is a Numerology Chart?',                              category:'practice'    },
    { id:'post-beginners',               path:'numerology-for-beginners',                           title:'Numerology for Beginners',                                 category:'practice'    },
    { id:'post-name-numerology',         path:'name-numerology',                                    title:'Name Numerology',                                          category:'practice'    },
    { id:'post-master-44',               path:'master-number-44-numerology',                        title:'Master Number 44',                                         category:'numbers'     },
    { id:'post-y-vowel',                 path:'is-y-a-vowel-in-numerology',                         title:'Is Y a Vowel in Numerology?',                              category:'practice'    },
    { id:'post-destiny-vs-expression',   path:'destiny-number-vs-expression-numerology',            title:'Destiny Number vs Expression Number',                      category:'practice'    },
    { id:'post-life-calling',            path:'life-calling-number-numerology',                     title:'Life Calling Number',                                      category:'practice'    },
    { id:'post-karmic-debt',             path:'karmic-debt-numbers-13-14-16-19',                    title:'Karmic Debt Numbers 13, 14, 16, 19',                       category:'practice'    },
    { id:'post-achievement',             path:'achievement-number-birthday-numerology',             title:'Achievement Number vs Birthday Number',                    category:'practice'    },
    ...
    { id:'post-compatibility',           path:'numerology-compatibility',                           title:'Numerology Compatibility',                                 category:'practice'    },
    { id:'post-1111',                    path:'1111-angel-number-meaning',                          title:'1111 Angel Number Meaning',                                category:'practice'    },
    { id:'post-444',                     path:'444-angel-number-meaning',                           title:'444 Angel Number Meaning',                                 category:'practice'    },
    { id:'post-maturity',                path:'maturity-number-vs-life-calling',                    title:'Maturity Number vs Life Calling',                          category:'practice'    },
    { id:'post-career',                  path:'career-numerology',                                  title:'Career Numerology',                                        category:'practice'    },
    { id:'post-compounds',               path:'compound-numbers-numerology',                        title:'Compound Numbers in Numerology',                           category:'practice'    },
    { id:'post-what-is-numerology',      path:'what-is-numerology',                                 title:'What Is Numerology?',                                     category:'practice'    },
    { id:'post-222',                     path:'222-angel-number-meaning',                           title:'222 Angel Number Meaning',                                category:'practice'    },
    { id:'post-555',                     path:'555-angel-number-meaning',                           title:'555 Angel Number Meaning',                                category:'practice'    },
    { id:'post-777',                     path:'777-angel-number-meaning',                           title:'777 Angel Number Meaning',                                category:'practice'    },
  ];
